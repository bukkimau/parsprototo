...
@Controller
public class CatalogController extends WebMvcConfigurerAdapter {
	...
	String addEntry(@Valid Comment comment, Errors errors) { // 1st attempt to get a different redirect when error occurs
	...
	/*
	public String checkCommentInfo(@Valid Comment comment, BindingResult bindingResult) { //2nd attempt
